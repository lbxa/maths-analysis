...
\begin{proof}[Solution]
  ...
  \begin{figure*}[h]
    \centering
    \input{figures/hw01/tangent-overview}
...
\begin{proof}[Solution]
  ...
  \begin{marginfigure}
    \centering
    \input{figures/hw01/identity-map}
  ...
  \begin{figure}[h]
    \centering
    \input{figures/hw01/reciprocal-shift}
...
\begin{proof}[Solution]
  ...
  \begin{marginfigure}
    \centering
    \input{figures/hw01/continuum-gap}
...
\begin{proof}[Solution]
  ...
  \begin{figure*}[h]
    \centering
    \input{figures/hw01/decimal-interleaving}
...
\begin{proof}[Solution]
  ...
  \begin{figure}[h]
    \centering
    \input{figures/hw01/diagonal-enumeration}
