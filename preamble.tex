...
% Use a full stop after caption numbers in homework handouts.
\makeatletter
\@ifclassloaded{tufte-handout}{%
  \patchcmd{\@caption}{\endcsname:}{\endcsname.}
    {}
    {\PackageError{analysis-notes}{Could not format caption punctuation}
      {Check the Tufte caption definition.}}
}{}
\makeatother
